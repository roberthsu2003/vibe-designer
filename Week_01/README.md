...
- **【主題 A：AI 科技顧問】**
    ...
    - **Prompt 進階三部曲 (由淺入深)**：
        ...
        3. **Lv3 (高階)**：`Abstract technology background, circuit board lines, neon blue and white gradient, minimalist style, 8k resolution, negative space on the right for text, clean composition. (抽象科技背景，電路板線條，霓虹藍白漸層，極簡風格，8k 高解析度，右側留白供文字排版，乾淨構圖)`
    - **範例作品**：
...
- **【主題 B：花藝/甜點師】**
    ...
    - **Prompt 進階三部曲 (由淺入深)**：
        ...
        3. **Lv3 (高階)**：`Abstract watercolor background, soft pastel colors, floral shapes, artistic texture, elegant vibe, clean space in the center, negative space for logo. (抽象水彩背景，柔和粉彩，花卉形狀，藝術紋理，優雅氛圍，中間乾淨留白，適合放置 Logo)`
    - **範例作品**：
